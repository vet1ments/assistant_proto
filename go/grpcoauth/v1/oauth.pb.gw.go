...
func request_OauthService_KakaoCallback_0(ctx context.Context, marshaler runtime.Marshaler, client OauthServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_OauthService_KakaoCallback_0(ctx context.Context, marshaler runtime.Marshaler, server OauthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq KakaoCallbackRequest
	var metadata runtime.ServerMetadata
...
func RegisterOauthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OauthServiceServer) error {
	...
	mux.Handle("GET", pattern_OauthService_KakaoCallback_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/grpcoauth.v1.OauthService/KakaoCallback", runtime.WithHTTPPathPattern("/callback/kakao"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_OauthService_KakaoCallback_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_OauthService_KakaoCallback_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOauthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OauthServiceClient) error {
	...
	mux.Handle("GET", pattern_OauthService_KakaoCallback_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/grpcoauth.v1.OauthService/KakaoCallback", runtime.WithHTTPPathPattern("/callback/kakao"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_OauthService_KakaoCallback_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_OauthService_KakaoCallback_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"callback", "kakao"}, ""))
)

var (
	forward_OauthService_KakaoCallback_0 = runtime.ForwardResponseMessage
)
